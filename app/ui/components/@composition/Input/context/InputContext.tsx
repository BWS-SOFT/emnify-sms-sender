...
interface InputContextProps {
	setShowError: React.Dispatch<
		React.SetStateAction<boolean>
	>
	showError: boolean
	possitionIcon: 'left' | 'right'
	setPositionIcon: React.Dispatch<
		React.SetStateAction<'left' | 'right'>
	>
	setAddOnIsIcon: React.Dispatch<
		React.SetStateAction<boolean>
	>
	addOnIsIcon: boolean
	classNameSetter: keyof ClassNameType
	useAddIcon: boolean
	setUseAddIcon: React.Dispatch<
		React.SetStateAction<boolean>
	>
}
...
export const InputProvider = ({
	...
	const [possitionIcon, setPositionIcon] = useState<
		'left' | 'right'
	>('left')
	const [addOnIsIcon, setAddOnIsIcon] = useState(false)
	const [useAddIcon, setUseAddIcon] = useState(false)
	const [classNameSetter, setClassNameSetter] =
		useState<keyof ClassNameType>('left')
